...
/***/ "./components/waterfall/index.tsx":
/*!****************************************!*\
  !*** ./components/waterfall/index.tsx ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"react\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! classnames */ \"./node_modules/classnames/index.js\");\n/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _utils_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_utils/dom */ \"./components/_utils/dom.ts\");\n\n\n\nvar Waterfall = function (props) {\n    var _a = props.prefixCls, prefixCls = _a === void 0 ? 'ty-waterfall' : _a, _b = props.columns, columns = _b === void 0 ? 5 : _b, _c = props.gap, gap = _c === void 0 ? 0 : _c, className = props.className, style = props.style, children = props.children;\n    var cls = classnames__WEBPACK_IMPORTED_MODULE_1___default()(prefixCls, className);\n    var containerRef = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n    var handleLayout = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useCallback\"])(function () {\n        var width = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_2__[\"getRect\"])().width;\n        var items = containerRef.current.children;\n        var itemWidth = width / columns;\n        var arr = [];\n        for (var i = 0; i < items.length; i++) {\n            var item = items[i];\n            item.children[0].style.width = itemWidth + \"px\";\n            if (i < columns) {\n                item.style.top = '0';\n                item.style.left = (itemWidth + gap) * i + 'px';\n                arr.push(item.offsetHeight);\n            }\n            else {\n                var minHeight = arr[0];\n                var index = 0;\n                for (var j = 0; j < arr.length; j++) {\n                    if (minHeight > arr[j]) {\n                        minHeight = arr[j];\n                        index = j;\n                    }\n                }\n                item.style.top = arr[index] + gap + 'px';\n                item.style.left = items[index].offsetLeft + 'px';\n                arr[index] = arr[index] + item.offsetHeight + gap;\n            }\n        }\n    }, [columns, gap]);\n    Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useEffect\"])(function () {\n        window.addEventListener('load', handleLayout);\n        window.addEventListener('resize', handleLayout);\n        return function () {\n            window.removeEventListener('load', handleLayout);\n            window.removeEventListener('resize', handleLayout);\n        };\n    }, [handleLayout]);\n    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"div\", { ref: containerRef, className: cls, style: style }, react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.map(children, function (child) {\n        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', { className: prefixCls + \"__item\" }, child);\n    })));\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (Waterfall);\n\n\n//# sourceURL=webpack://tiny/./components/waterfall/index.tsx?");
