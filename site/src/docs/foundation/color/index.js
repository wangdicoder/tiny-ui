...
export default () => {
    ...
    return (
        <div className="color-page">
            ...
            <p className="code-p">Tiny UI uses a specific set of palettes to specify colors to provide a consistent look
                and feel for the products you build.</p>

            <h2 className="code-heading-2">Primary colors</h2>
            <p className="code-p">Primary palette is comprised of neutrals, white, and purple. These colors are present
                across most touch points from marketing to product.</p>
            ...
            <p className="code-p">Light neutrals are helpful for offsetting content in a primarily white layout without
                losing warmth and cleanliness, and are therefore often used as a background color for web
                components.</p>
            ...
            <div className="code-table-container">
                <table className="color-page__table">
                    ...
                    {NEUTRALS.map((color) => (
                        <tr key={color.hex}>
                            <td>
                                <span className="color-page__color-block" style={{ backgroundColor: color.hex }}/>
