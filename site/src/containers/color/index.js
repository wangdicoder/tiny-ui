...
export default () => {
	...
	return (
		<div className="color-page">
			...
			<p className="code-p">Tiny UI uses a specific set of palettes to specify colors to provide a
				consistent look
				and feel for the products you build.</p>

			<h2 className="code-heading-2">Primary colors</h2>
			<p className="code-p">Primary palette is comprised of neutrals, white, and purple. These
				colors are present
			...
			<p className="code-p">Light neutrals are helpful for offsetting content in a primarily white
				layout without
